...
public class SetWarpCommand implements CommandExecutor,TabCompleter, Listener {
...
//		}
		...
		if(args.length == 0){
			sender.sendMessage("§c" + Message.USAGE.get(sender) + ": §7/setwarp <name>");
			return true;
		}
		...
		Main.getInstance().getWarpManager().newWarp(player, query.toString());
